...
begin
    ...
    select r.RecipeId, r.RecipeName, r.RecipeStatus, r.Calories, r.CuisineId, r.DateDraft, r.DatePublished,
     r.DateArchived, r.StaffId, 'user' = concat(s.StaffFirstName, ' ', s.StaffLastName), r.RecipePic, r.IsVegan, NumIngredients = count(ri.ingredientid)
    from recipe r
    ...
    group by r.recipeid, r.recipename, r.RecipeStatus, r.calories, r.cuisineid, r.DateDraft, r.DatePublished, r.DateArchived, r.StaffId, s.StaffFirstName, s.StaffLastName,  r.RecipePic, r.IsVegan
end
go
